...
@user84 @web
Scenario: Como usuario inicio sesión, voy a la sección de "Pages", 
# selecciono la primera página, 
# voy a la sección de "post settings" 
# y remuevo la imagen asociada a la página. 
# Guardo los cambios, vuelvo a la sección de "Páginas" 
# y reviso que la foto se haya eliminado.
