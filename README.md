...
|E7| Como usuario quiero iniciar sesión, acceder a la opción “staff”, invitar un usuario como autor, recargar la página, volver a la sección de staff, buscar el usuario invitado y revocar la invitación. Al ecargar la página y en la sección de staff ya no debería aparecer la invitación. |2| Johana Ojeda|
...
|E10| Como usuario quiero hacer inicio de sesión, ir al apartado de "staff", ver la información del usuario, eliminar la foto de perfil, volver al apartado de "posts", volver al apartado de "staff" y verificar en la pantalla principal que la foto del usuario se eliminó satisfactoriamente. |2| Johana Ojeda|
