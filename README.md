...
|E7| Como usuario quiero hacer inicio de sesión, ir al apartado de "staff", ver la información del usuario, eliminar la foto de perfil, volver al apartado de "posts", volver al apartado de "staff" y verificar en la pantalla principal que la foto del usuario se eliminó satisfactoriamente. |2| Johana Ojeda|
